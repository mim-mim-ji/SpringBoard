...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="/">
      	<img class="img-fluid" src="<c:url value='/img/mark.png'/>" alt="" style="width:100px; height:70px;" />
      </a>
  ...
  <header class="masthead">
    ...
    <c:if test="${login == null}" >
        <button class="btn btn-chu btn-xl text-uppercase js-scroll-trigger" data-toggle="modal" data-target="#log-in">BTS</button>
    </c:if>
    <c:if test="${login != null}" >
    	 <a class="btn btn-chu btn-xl text-uppercase js-scroll-trigger" href="#">${login.name}님 환영합니다</a>
    </c:if>
      </div>
    </div>
  </header>
